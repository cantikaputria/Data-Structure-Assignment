...
//ADD FIRST
void addFirst(char nama[], char level[], char asal[], list *L)  //parameternya adalah isi kontainer dan list yg akan ditambahkan
{
...
{   
    //jika elemen yg terisi kurang dari 5 maka
    if(countElement(*L) < 5)
    {   
        //buat pointer baru di elemen yg masih kosong
        //baru adalah elemen kosong yg ditemukan pertama kali
