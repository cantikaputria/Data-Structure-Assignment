...
void addFirstK(char barang[], eBaris *L)
{
    ...
    strcpy(baru->kontainer_kol.barang, barang);
...
eBaris* get(char kode[], list L)
{
    ...
    while (tunjuk != NULL)
    {
        //kode yg diyunjuk /kode yg dij
        if(strcmp(tunjuk->kontainer.kode, kode) == 0)
        {
            return tunjuk;
        }
        else
